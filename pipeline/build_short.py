...
def main():
    ...
    # Static stills (clean and crisp). Ken-Burns/zoompan motion was tried and removed — it
    # stepped pixel-by-pixel per frame and read as choppy. Captions carry the motion instead.
    vin, vparts = [], []
