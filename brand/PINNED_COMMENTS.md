# Pinned-comment bank (per short)

Pattern: **one bonus jaw-drop tied to the video → "Become a Stan" + daily promise → "drop a fact" loop.**
Post as a normal comment, then ⋮ → Pin. Heart the first few replies.

Generic (any standalone wonder short):
> Become a Stan 👇 a new wonder every day. Drop a "wait, that's true?" fact below — I might make it into a short.

## Tailored
**Caesar's last breath** (6PgSzMnttaM)
> That same breath has Cleopatra, every dinosaur, and you in it. 🤯 Become a Stan 👇 a new wonder every day — drop a "wait, that's true?" fact below and I might make it a short.

**Venus — day longer than year** (dyvMtdonEfk)
> Yep — Venus spins so slow that one day there lasts longer than its whole trip around the sun. Oh, and it spins *backwards*. 🤯 Become a Stan 👇 a new wonder every day — drop a "wait, that's true?" fact below and I might make it a short.
