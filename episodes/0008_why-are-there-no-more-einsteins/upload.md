# Upload Kit — Why Are There No More Einsteins?

## Title
Why Are There No More Einsteins?

(alts to A/B: "Where Did All the Geniuses Go?" · "Why Can't You Name a Living Genius?")
...
## Tags (search-intent first, ~14)
why are there no more einsteins, where did all the geniuses go, why are there no geniuses today, einstein 1905 miracle year, einstein patent clerk, burden of knowledge, are ideas getting harder to find, why science needs teams now, what makes a genius, lone genius myth, gps relativity einstein, living geniuses today, the hidden why, Playedd

## Disclosure (REQUIRED)
In YouTube Studio, check **"Altered or synthetic content"** on upload. The note is already in the description. (brand/FORMATS.md Rule 3.)

## Thumbnails (3 DISTINCT options for A/B — in thumbnails/)
1. `01_wheredtheygo.png` — Stan shrugging up at a giant Einstein silhouette + red "?", caps **"WHERE'D THEY GO?"**
2. `02_aclerkdidthis.png` — doodle-Einstein at the patent desk scribbling E=mc², caps **"A CLERK DID THIS?"**
3. `03_whosnext.png` — glowing lineup Einstein/Newton/Da Vinci + one empty spot, caps **"WHO'S NEXT?"**

## Notes
- First "figure as anchor" episode (history + psychology, NOT a biography). Stan = the modern everyman; doodle-Einstein = one-off recognizable figure (wild hair + mustache).
- End card = silent like/subscribe outro, lower-left, center + top-right clear. No CTA text on the main video.
- 4 teaser shorts (name-one / patent-clerk / GPS / the-twist), each withholds the payoff, ends on logo + arrow "FOR FULL BREAKDOWN." Post the episode first, drip shorts after.
- Runtime ~5:54 narration (locked script), ~6:01 with outro. Just under the 6-9 band; flagged for Logan.
